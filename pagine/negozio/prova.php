...
$query="SELECT * FROM ef_schema.prodotto, ef_schema.ordine_prodotto, ef_schema.ordine,
ef_schema.cliente_ordine, ef_schema.cliente
WHERE ef_schema.prodotto.codice=codice_prodotto
AND ef_schema.ordine_prodotto.codice_ordine=ef_schema.ordine.codice
AND ef_schema.ordine.codice=ef_schema.cliente_ordine.codice_ordine AND username=username_cliente
