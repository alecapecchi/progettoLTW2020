          ...
          <div  id="bestproducts" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100 img-carousel" src="../img/clementoni.png" alt="...">
              </div>
              <div class="carousel-item ">
                <img class="d-block w-100 img-carousel" src="../img/dixit.png" alt="...">
              </div>
              <div class="carousel-item ">
    ...
    <div class="mx-auto">
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><a class="page-link" href="board.php">1</a></li>
            <li class="page-item">
