...
$count3=0;
$count2=0;
while($line=pg_fetch_array($result,null,PGSQL_ASSOC) and $count3<24){
if($count3>=12){
...
foreach($line as $col_value){
    ...
    $count+=1;}
        ...
        $url="/pagine/prodotti/all_prod_2.php?action=popup#card_".$count3;
    ...
    <div class="mx-auto">
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
              <a class="page-link" href="all_prod_3.php" aria-label="Next">
