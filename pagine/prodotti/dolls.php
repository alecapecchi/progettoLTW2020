          ...
          <div  id="bestproducts" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100 img-carousel" src="../img/barbie_house.png" alt="...">
              </div>
...
$query="SELECT * FROM ef_schema.prodotto WHERE categoria='Bambole' ORDER BY codice";
...
foreach($line as $col_value){
   ...
   $url="/pagine/prodotti/dolls.php?action=popup#card_".$codice;
    ...
    <div class="mx-auto">
        <nav aria-label="Page navigation example">
          <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><a class="page-link" href="dolls.php">1</a></li>
            <li class="page-item">
